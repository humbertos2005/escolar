...
def get_proximo_rfo_id(incrementar=False):
    ...
    try:
        ...
        rfo_id = f"RFO-{ano_atual}-{str(proximo_numero).zfill(4)}"
...
def get_proximo_fmd_id(incrementar=False):
    ...
    try:
        ...
        fmd_id = f"FMD-{ano_atual}-{str(proximo_numero).zfill(4)}"
